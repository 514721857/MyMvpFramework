 ...
 * 自定义下拉刷新头部
 */
public class CustomClassicHeader extends FrameLayout implements PtrUIHandler {
    ...
    public CustomClassicHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public CustomClassicHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.cube_ptr_classic_custom_header, this);
